            ...
            while($row = mysqli_fetch_assoc($result)) { ?>
                ...
                <div class="row row-cols-2">
                    ...
                    <div class="col-sm-6 mt-3">
                        ...
                        <div class="button">
                            <a href="project_seeallmember.php?p_id=<?php echo $row['p_id']; ?>"><button class="createbtn1">See All</button></a>
                        </div>
                    </div>
                </div><br>
                ...
                <div class="row row-cols-2">
                    ...
                    <div class="col-sm-6 mt-3">
                        <div class="button">
                            <a href="project_addactivity_member.php?p_id=<?php echo $row['p_id']; ?>"><button class="createbtn">Add Activity +</button></a>
                        </div>
                    

                    <div class="col-sm-6 mt-3">
                        <div class="button">
                            <a href="project_seeallactivity.php?p_id=<?php echo $row['p_id']; ?>"><button class="createbtn1">See All</button></a>
                        </div>
                    </div>
                </div><br>
