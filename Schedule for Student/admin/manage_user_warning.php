...
<body>
    ...
    <div id="successPopup" class="popup">
        ...
        <p class="popup-text">Are you sure <br> You want to delete this user?</p><br>
    ...
    <script>
        ...
        function cancel() {
            ...
            // For example:
            window.location.href = "manage_user.php"; // Redirect to login page
        }
        function confirm() {
            // Define your login function here
            // For example:
            window.location.href = "delete_user_db.php?u_id=<?php echo $u_id; ?>"; // Redirect to login page
        }
